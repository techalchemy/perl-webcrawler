...
## @fn public static void performCrawl($configFilePath)
# this is the entry point of the script
sub performCrawl
{
	# assumes config file path is first parameter
	# grab config file path
	my $configFilePath = retrieveAndVerifyConfigurationFilePath($_[0]);
	...
	# load the seeds file
	my @seeds = getSeeds($options{'seedFilename'});
...
sub retrieveAndVerifyConfigurationFilePath
{
	...
	{
		print "unable to get config file specified, program exiting\n";
		exit(1);
	}
}
